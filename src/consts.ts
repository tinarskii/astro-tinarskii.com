...
export const education = [
  ...
  {
    name: "Assumption College Samutprakarn",
    level: "Secondary School (S.1 - S.3)",
    grade: "4.00 (Secondary 3)",
...
export const events = [
  ...
  {
    name: "งานแข่งขัน Coding มัธยมต้น ม.1-3 (ระดับจังหวัด)",
  ...
  {
    name: "งานแข่งขัน Coding มัธยมต้น ม.1-3 (ระดับภูมิภาค)",
    org: "Office of the Private Education Commission",
    roles: "Participant",
    info: "",
  ...
  {
    name: "ACSP Smart Student and Outstanding Smart Student Award 2024",
    org: "Assumption College Samutprakarn",
    roles: "Nominee",
    info: "",
